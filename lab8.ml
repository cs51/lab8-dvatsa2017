...
let id_event0 = WEvent.add_listener newswire fakeNewsNetwork ;;
let id_event1 = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire id_event0 ;;
WEvent.remove_listener newswire id_event1 ;;
...
let receive_report = fun (x : string) -> ignore (WEvent.add_listener publish (fun () -> fakeNewsNetwork x));
                                         ignore (WEvent.add_listener publish (fun () -> buzzFake x));;
